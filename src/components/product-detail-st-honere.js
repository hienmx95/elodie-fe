...
import SingleProductStHonore from './shop-components/single-product-st-honore';
import RelatedProduct from './shop-components/related-product-st-honore';
...
export default ProductDetailStHonere
